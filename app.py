...
if st.button("Predict Cardiac Risk", type="primary"):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            st.divider()
            report_content = f"""Patient Risk Prediction Report
--------------------------------------
Age: {age}
...
Prediction Result: {risk_level.split()[0]} Risk
Risk Probability: {prob:.1%}

Note: This result is generated by an Artificial Neural Network model for academic purposes only. It is not a replacement for professional medical diagnosis.
"""
            st.download_button(
                label="📄 Download Patient Report",
                data=report_content,
                file_name="patient_cardiac_risk_report.txt",
                mime="text/plain",
                type="secondary"
            )
